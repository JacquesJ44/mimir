...
class DbUtil:
    ...
    # Save a new circuit
    def save_circuit(self, vendor, circuitType, speed, circuitNumber, circuitOwner, usageFlag, enni, vlan, startDate, contractTerm, endDate, mrc, sellingPrice, siteA, siteB, comments, status, doc, salesPerson, commission):
        con = self.get_connection()

        try:
            with con.cursor() as c:
                c.execute(
                   'INSERT INTO circuits (vendor, circuitType, speed, circuitNumber, circuitOwner, usageFlag,enni, vlan, startDate, contractTerm, endDate, mrc, sellingPrice, siteA, siteB, comments, status, doc, salesPerson, commission) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)', 
                    (vendor, circuitType, speed, circuitNumber, circuitOwner, usageFlag, enni, vlan, startDate, contractTerm, endDate, mrc, sellingPrice, siteA, siteB, comments, status, doc, salesPerson, commission)
                )
                con.commit()
                return c.lastrowid
        finally:
